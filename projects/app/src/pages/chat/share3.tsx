...
const OutLink = (props: Props) => {
  ...
  const checkAuthToken = () => {
    ...
    if (!authToken) {
      ...
      window.location.href = 'http://117.72.49.30:15080/login'; // 为空时跳转
  ...
  const RenderHistoryList = useMemo(() => {
    ...
    return isPc ? (
      <SideBar 
        sx={{
          backgroundColor: '#f0f3f9', // 浅蓝色背景
          borderRight: '1px solid #d1d9e6', // 添加右侧边框
          boxShadow: '2px 0px 5px rgba(0,0,0,0.05)' // 添加阴影
        }}
      >
        {Children}
      </SideBar>
          ...
          >
            ...
            {showHead === '1' ? (
              <ChatHeader
                ...
                sx={{
                  backgroundColor: '#f0f3f9', // 浅蓝色背景
                  borderBottom: '1px solid #d1d9e6', // 添加底部边框
                  boxShadow: '0 2px 5px rgba(0,0,0,0.05)' // 添加阴影
                }}
              />
            ) : null}
            ...
            <Box
              ...
              sx={{
                ...
                '.chat-item': {
                  ...
                  '&.user-chat': {
                    '.chat-item-content': {
                      backgroundColor: '#1890ff', // 用户消息蓝色气泡
                      color: 'white',
                  ...
                  '&.assistant-chat': {
                    '.chat-item-content': {
                      backgroundColor: 'white', // AI消息白色气泡
